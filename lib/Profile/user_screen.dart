  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(color: ColorUtils().primary.withOpacity(0.1),),
            SizedBox(height: 20.h,),
            Row(
              ...
              children: [
                ...
                Icon(Icons.arrow_forward_ios_rounded, size: 11.sp,)
              ],
            ),
            SizedBox(height: 20.h,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Terms & Conditions", style: GoogleFonts.inter(
                  fontSize: 12.sp,
                ),),
                Icon(Icons.arrow_forward_ios_rounded, size: 11.sp,)
              ],
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Send Feedback", style: GoogleFonts.inter(
                  fontSize: 12.sp,
                ),),
                Icon(Icons.arrow_forward_ios_rounded, size: 11.sp,)
              ],
      ...
      bottomNavigationBar: Container(
        height: 20.h,
        child: Center(
          child: Text("v1.0.0", style: GoogleFonts.inter(
            fontSize: 11.sp,
